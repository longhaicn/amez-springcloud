...
public class StoreVo implements Serializable {
     ...
     * 入驻状态，0-待完善资料
     */
    public static final int SETTLED_STATUS_INFO = 0;
    /**
     * 入驻状态，1-待完善资质
     */
    public static final int SETTLED_STATUS_QUALIFICATION = 1;
    /**
     * 入驻状态，2-待审核
     */
    public static final int SETTLED_STATUS_PENDING = 2;
    /**
     * 入驻状态，3-审核不通过
     */
    public static final int SETTLED_STATUS_NO_PASS = 3;
    /**
     * 入驻状态，4-完成入驻
     */
    public static final int SETTLED_STATUS_SETTLED = 4;
    ...
    @ApiModelProperty("入驻状态，0-待完善资料，1-待完善资质，2-待审核，3-审核不通过，4-完成入驻")
