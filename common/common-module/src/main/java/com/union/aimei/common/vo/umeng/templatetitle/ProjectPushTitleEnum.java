 ...
 */
public enum ProjectPushTitleEnum {
    /**
     * 项目消息推送枚举
     */
    BEAUTICIAN_APPLY_PROJECT_TO_STORE_KEY_VALUE("邦女郎进行项目申请操作推送消息给店长","beauticianname","美容师名字"),
    BEAUTICIAN_AGREE_PROJECT_TO_STORE_KEY_VALUE("邦女郎处理门店项目邀约 （同意）推送消息给店长","beauticianname","美容师名字"),
    BEAUTICIAN_NOTAGREE_PROJECT_TO_STORE_KEY_VALUE("邦女郎处理门店项目邀约 （同意）推送消息给店长","beauticianname","美容师名字"),
    STORE_INVITES_TO_BEAUTICIAN_KEY_VALUE("门店对邦女郎进行项目邀约推送消息给美容师",null,null),
    STORE_AGREE_APPLY_TO_STORE_KEY_VALUE("门店处理邦女郎项目申请结果（同意）推送消息给美容师",null,null),
    STORE_NOTAGREE_APPLY_TO_STORE_KEY_VALUE("门店处理邦女郎项目申请结果（不同意）推送消息给美容师",null,null),
    PLATFORM_AGREE_COURSE_TO_BEAUTICIAN_KEY_VALUE("平台处理邦女郎的课程评测推送送消息给美容师",null,null),

    MAKEMONEY_TO_BEAUTICIAN_KEY_VALUE("后台给美容师提现申请打款推送消息给美容师",null,null),
    MAKEMONEY_TO_STORE_KEY_VALUE("后台给店铺月账单打款推送消息给店长",null,null),
    ...
    STORE_NOTAGREE_CHANGE_HAND_TO_BEAUTICIAN_KEY_VALUE("门店处理邦女郎挂靠更改申请（不同意）推送消息给美容师",null,null),
    ...
    ProjectPushTitleEnum(String description, String key, String value) {
