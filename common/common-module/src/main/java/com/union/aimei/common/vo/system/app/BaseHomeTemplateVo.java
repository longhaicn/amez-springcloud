...
public class BaseHomeTemplateVo implements Serializable {
    ...
    private Map<String, BaseHomeTemplate> baseHomeTemplateMap;
     ...
     * 使用类型 1-帮女郎，
     */
    public static final Integer USER_TYPE_HELP_GIRL = 1;
    /**
     * 使用类型 2-门店端
     */
    public static final Integer USER_TYPE_STORE_SIDE = 2;
}
