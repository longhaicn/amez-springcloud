...
import com.union.aimei.common.feign.app.umeng.hystrix.BaseUmengPushTemplateApiHystrix;
 ...
 */
@FeignClient(serviceId="APP-UMENG-SERVICE",fallback=BaseUmengPushTemplateApiHystrix.class)
