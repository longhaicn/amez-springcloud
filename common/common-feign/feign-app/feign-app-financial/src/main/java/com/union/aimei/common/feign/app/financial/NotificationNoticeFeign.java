...
import com.union.aimei.common.feign.app.financial.hystrix.NotificationNoticeHystrix;
 ...
 * @author liufeihua
 */
@FeignClient(name = "app-financial-service", fallback = NotificationNoticeHystrix.class)
