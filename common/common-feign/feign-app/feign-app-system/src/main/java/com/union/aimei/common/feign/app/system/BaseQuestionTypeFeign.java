...
import com.union.aimei.common.feign.app.system.hystrix.BaseQuestionTypeHystrix;
 ...
 * @author dell
 */
@FeignClient(name = "app-system-service", fallback = BaseQuestionTypeHystrix.class)
