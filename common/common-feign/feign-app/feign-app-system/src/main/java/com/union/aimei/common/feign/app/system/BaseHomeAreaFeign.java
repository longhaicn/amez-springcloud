...
import com.union.aimei.common.feign.app.system.hystrix.BaseHomeAreaApiHystrix;
 ...
 **/
@FeignClient(serviceId = "app-system-service", fallback = BaseHomeAreaApiHystrix.class)
public interface BaseHomeAreaFeign {
    ...
    int insert(@RequestBody BaseHomeArea baseHomeArea);
