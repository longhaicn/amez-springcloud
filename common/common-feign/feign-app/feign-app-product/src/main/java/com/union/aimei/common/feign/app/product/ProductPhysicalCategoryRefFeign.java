...
import com.union.aimei.common.feign.app.product.hystrix.ProductPhysicalCategoryRefApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-PRODUCT-SERVICE", fallback = ProductPhysicalCategoryRefApiHystrix.class)
