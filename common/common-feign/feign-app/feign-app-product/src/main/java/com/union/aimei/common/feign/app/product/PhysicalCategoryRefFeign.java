...
import com.union.aimei.common.feign.app.product.hystrix.PhysicalCategoryRefApiHystrix;
 ...
 **/
@FeignClient(serviceId = "APP-PRODUCT-SERVICE", fallback = PhysicalCategoryRefApiHystrix.class)
