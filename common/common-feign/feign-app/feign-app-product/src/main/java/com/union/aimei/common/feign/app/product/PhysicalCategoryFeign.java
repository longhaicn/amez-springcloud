...
import com.union.aimei.common.feign.app.product.hystrix.PhysicalCategoryApiHystrix;
 ...
 **/
@FeignClient(serviceId = "APP-PRODUCT-SERVICE", fallback = PhysicalCategoryApiHystrix.class)
public interface PhysicalCategoryFeign {
     ...
     * @return
     */
    @PostMapping("/physicalCategory/1.1.1/front/findByForFront")
    PageInfo<PhysicalCategory> findByForFrontV111(@RequestBody PhysicalCategory physicalCategory);
