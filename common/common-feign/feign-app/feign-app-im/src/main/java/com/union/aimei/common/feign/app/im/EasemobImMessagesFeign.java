...
import com.union.aimei.common.feign.app.im.hystrix.EasemobImMessagesFeignHystrix;
 ...
 */
@FeignClient(serviceId = "APP-IM-SERVICE", fallback = EasemobImMessagesFeignHystrix.class)
