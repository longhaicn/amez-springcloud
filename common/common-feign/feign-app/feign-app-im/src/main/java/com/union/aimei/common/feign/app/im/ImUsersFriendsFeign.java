...
import com.union.aimei.common.feign.app.im.hystrix.ImUsersFriendsApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-IM-SERVICE", fallback = ImUsersFriendsApiHystrix.class)
