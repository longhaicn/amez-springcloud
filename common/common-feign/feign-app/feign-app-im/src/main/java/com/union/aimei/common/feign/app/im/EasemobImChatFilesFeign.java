...
import com.union.aimei.common.feign.app.im.hystrix.EasemobImChatFilesFeignHystrix;
 ...
 */
@FeignClient(serviceId = "APP-IM-SERVICE", fallback = EasemobImChatFilesFeignHystrix.class)
