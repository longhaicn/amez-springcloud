...
import com.union.aimei.common.feign.app.im.hystrix.EasemobImChatGroupsFeignHystrix;
 ...
 */
@FeignClient(serviceId = "APP-IM-SERVICE", fallback = EasemobImChatGroupsFeignHystrix.class)
