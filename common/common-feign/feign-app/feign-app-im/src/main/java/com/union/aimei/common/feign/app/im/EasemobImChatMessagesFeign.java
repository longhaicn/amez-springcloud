...
import com.union.aimei.common.feign.app.im.hystrix.EasemobImChatMessagesFeignHystrix;
 ...
 */
@FeignClient(serviceId = "APP-IM-SERVICE", fallback = EasemobImChatMessagesFeignHystrix.class)
