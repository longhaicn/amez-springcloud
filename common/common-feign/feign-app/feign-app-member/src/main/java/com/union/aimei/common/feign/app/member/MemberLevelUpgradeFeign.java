...
import com.union.aimei.common.feign.app.member.hystrix.MemberLevelUpgradeApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-MEMBER-SERVICE", fallback = MemberLevelUpgradeApiHystrix.class)
