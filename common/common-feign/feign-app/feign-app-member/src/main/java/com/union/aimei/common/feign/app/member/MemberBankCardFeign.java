...
import com.union.aimei.common.feign.app.member.hystrix.MemberBankCardApiHystrix;
 ...
 */
@FeignClient(serviceId="APP-MEMBER-SERVICE",fallback=MemberBankCardApiHystrix.class)
