...
import com.union.aimei.common.feign.app.store.hystrix.StoreLevelUpgradeLogApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-STORE-SERVICE", fallback = StoreLevelUpgradeLogApiHystrix.class)
