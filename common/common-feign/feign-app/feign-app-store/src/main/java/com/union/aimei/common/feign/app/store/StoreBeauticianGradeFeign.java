...
import com.union.aimei.common.feign.app.store.hystrix.StoreBeauticianGradeApiHystrix;
 ...
 **/
@FeignClient(serviceId = "APP-STORE-SERVICE", fallback = StoreBeauticianGradeApiHystrix.class)
public interface StoreBeauticianGradeFeign {
     ...
     * @return
     */
    @DeleteMapping("/storeBeauticianGrade/1.1.1/deleteByStoreBeauticianGrade/{id}")
    ResponseMessage deleteByStoreBeauticianGradeV111(@PathVariable(value = "id") int id);
}