...
import com.union.aimei.common.feign.app.store.hystrix.StoreExtendOperationLogApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-STORE-SERVICE", fallback = StoreExtendOperationLogApiHystrix.class)
