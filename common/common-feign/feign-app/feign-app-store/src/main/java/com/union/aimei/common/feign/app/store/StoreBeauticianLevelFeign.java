...
import com.union.aimei.common.feign.app.store.hystrix.StoreBeauticianLevelApiHystrix;
 ...
 */
@FeignClient(serviceId = "APP-STORE-SERVICE", fallback = StoreBeauticianLevelApiHystrix.class)
