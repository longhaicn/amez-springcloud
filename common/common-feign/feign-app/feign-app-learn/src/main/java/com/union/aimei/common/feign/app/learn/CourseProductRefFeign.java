...
import com.union.aimei.common.feign.app.learn.hystrix.CourseProductRefApiHystrix;
 ...
 **/
@FeignClient(serviceId = "APP-LEARN-SERVICE", fallback = CourseProductRefApiHystrix.class)
