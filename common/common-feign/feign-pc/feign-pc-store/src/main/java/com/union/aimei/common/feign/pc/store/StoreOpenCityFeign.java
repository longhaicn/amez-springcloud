...
import com.union.aimei.common.feign.pc.store.hystrix.StoreOpenCityApiHystrix;
 ...
 */
@FeignClient(serviceId = "PC-STORE-SERVICE", fallback = StoreOpenCityApiHystrix.class)
public interface StoreOpenCityFeign {
    ...
    PageInfo<StoreOpenCity> findByPageForFront(@RequestParam(value = "pageNo", defaultValue = "0")
                                                       Integer pageNo, @RequestParam(value = "pageSize", defaultValue = "10")
                                                       Integer pageSize, @RequestBody StoreOpenCity storeOpenCity);
}