...
import com.union.aimei.common.feign.pc.store.hystrix.GrowthRuleLogApiHystrix;
 ...
 **/
@FeignClient(serviceId = "PC-STORE-SERVICE", fallback = GrowthRuleLogApiHystrix.class)
