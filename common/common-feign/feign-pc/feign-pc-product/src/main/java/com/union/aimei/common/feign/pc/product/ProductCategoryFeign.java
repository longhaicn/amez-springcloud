...
import com.union.aimei.common.feign.pc.product.hystrix.ProductCategoryApiHystrix;
 ...
 * @time 2018/1/5 19:15
 */
@FeignClient(serviceId = "PC-PRODUCT-SERVICE", fallback = ProductCategoryApiHystrix.class)
public interface ProductCategoryFeign {
    ...
    PageInfo<ProductCategory> findByPageForFront(@RequestParam(value = "pageNo", defaultValue = "0") Integer pageNo,
