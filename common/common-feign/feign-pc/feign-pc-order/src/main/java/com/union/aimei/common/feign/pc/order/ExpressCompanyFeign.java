...
import com.union.aimei.common.feign.pc.order.hystrix.ExpressCompanyApiHystrix;
...
@FeignClient(serviceId = "pc-order-service", fallback = ExpressCompanyApiHystrix.class)
public interface ExpressCompanyFeign {
    ...
    int insert(@RequestBody ExpressCompany expressCompany);
    ...
    int edit(@RequestBody ExpressCompany expressCompany);
    ...
    ExpressCompany queryById(@PathVariable(value = "id") int id);
