...
import com.union.aimei.common.feign.pc.system.hystrix.BaseOfficialDocumentsHystrix;
...
@FeignClient(name = "pc-system-service", fallback = BaseOfficialDocumentsHystrix.class)
