...
import com.union.aimei.common.feign.pc.system.hystrix.BaseDicGroupItemHystrix;
 ...
 * @author dell
 */
@FeignClient(name = "pc-system-service", fallback = BaseDicGroupItemHystrix.class)
