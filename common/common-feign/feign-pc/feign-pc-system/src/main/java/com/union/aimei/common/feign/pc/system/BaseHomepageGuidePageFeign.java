...
import com.union.aimei.common.feign.pc.system.hystrix.BaseHomepageGuidePageHystrix;
...
@FeignClient(name = "pc-system-service", fallback = BaseHomepageGuidePageHystrix.class)
