...
import com.union.aimei.common.feign.pc.system.hystrix.BaseNotificationNoticeHystrix;
 ...
 * @author dell
 */
@FeignClient(name = "pc-system-service", fallback = BaseNotificationNoticeHystrix.class)
