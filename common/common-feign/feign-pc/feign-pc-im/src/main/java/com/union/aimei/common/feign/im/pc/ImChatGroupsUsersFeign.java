...
import com.union.aimei.common.feign.im.pc.hystrix.ImChatGroupsUsersApiHystrix;
 ...
 */
@FeignClient(serviceId = "PC-IM-SERVICE", fallback = ImChatGroupsUsersApiHystrix.class)
