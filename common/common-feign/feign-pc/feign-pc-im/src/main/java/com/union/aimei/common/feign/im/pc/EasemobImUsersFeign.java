...
import com.union.aimei.common.feign.im.pc.hystrix.EasemobImUsersFeignHystrix;
 ...
 */
@FeignClient(serviceId = "PC-IM-SERVICE", fallback = EasemobImUsersFeignHystrix.class)
