...
public class BaseUmengPushHistoryApiController {
     ...
     */
       @ApiOperation(httpMethod="POST", value="前端分页查询友盟消息推送记录")
	 ...
	 Integer pageSize, @ApiParam(value="查询条件") @RequestBody BaseUmengPushHistory baseUmengPushHistory) {
        ...
        * @return
        */
       @ApiOperation(httpMethod="POST", value="添加友盟消息推送记录")
       @PostMapping("/insert")
        ...
        * @return
        */
       @ApiOperation(httpMethod="DELETE", value="删除友盟消息推送记录")
        ...
        * @return
        */
       @ApiOperation(httpMethod="PUT", value="编辑友盟消息推送记录")
       @PutMapping("/edit")
        ...
        */
       @ApiOperation(httpMethod="GET", value="通过ID查询友盟消息推送记录")
