...
public class BasePushTemplateApiController {
     ...
     */
	 ...
	 Integer pageSize, @ApiParam(value="查询条件") @RequestBody BasePushTemplate basePushTemplate) {
       ...
       @ApiOperation(httpMethod="GET", value="后台测是推送通知接口")
       @GetMapping("/test/sendNotificat/{token}/{role}/{deviceType}")
       public ResponseMessage testNotificat(
              ...
              return this.basePushTemplateFeign.testNotificat(role,token,deviceType);
       }
}