...
public class SmsController {
    ...
    public ResponseMessage<Integer> sendSmsMessageCode(@RequestBody SmsMessageVo smsMessageVo) {

        return new ResponseMessage<>(sendSmsFeign.sendSmsMessageCode(smsMessageVo));
    }
