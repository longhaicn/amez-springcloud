...
import com.union.aimei.pc.order.mapper.OrderReturnProductMapper;
...
public class OrderReturnProductServiceImpl implements OrderReturnProductService {
        ...
        */
       @Override
       public int addObj(OrderReturnProduct t) {
              return this.orderReturnProductMapper.insertSelective(t);
       }
        ...
        */
       @Override
       public int modifyObj(OrderReturnProduct t) {
              return this.orderReturnProductMapper.updateByPrimaryKeySelective(t);
       }
