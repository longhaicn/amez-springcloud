...
public class OrderGoodsInfoServiceImpl implements OrderGoodsInfoService {
       ...
       @Override
       public ResponseMessage<List<OrderGoodsInfo>> queryByOrderGoodsId(Integer orderGoodsId) {
              ResponseMessage<List<OrderGoodsInfo>> res=new ResponseMessage<>();
              List<OrderGoodsInfo> list=orderGoodsInfoMapper.queryByOrderGoodsId(orderGoodsId);
