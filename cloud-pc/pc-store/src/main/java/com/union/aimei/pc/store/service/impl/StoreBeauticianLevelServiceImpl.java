...
import com.union.aimei.pc.store.mapper.StoreBeauticianLevelMapper;
...
public class StoreBeauticianLevelServiceImpl implements StoreBeauticianLevelService {
    ...
    @Override
    public ResponseMessage addByBatch(StoreBeauticianLevelByBatchVo storeBeauticianLevelByBatchVo) {
        ResponseMessage responseMessage = new ResponseMessage();
        // 删除所有美容师等级
        this.storeBeauticianLevelMapper.deleteByAll();
        // 批量添加美容师等级
        if (!storeBeauticianLevelByBatchVo.getStoreBeauticianLevelList().isEmpty()) {
            this.storeBeauticianLevelMapper.addByBatch(storeBeauticianLevelByBatchVo);
        }
        return responseMessage;
    }
