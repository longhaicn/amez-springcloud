...
public class BaseMemberDeviceController {
	 ...
	 Integer pageSize, @ApiParam(value="查询条件") @RequestBody BaseMemberDevice baseMemberDevice) {
       ...
       @GetMapping("/queryByMemberId/{memberId}")
       public BaseMemberDevice queryByMemberId(@PathVariable (value="memberId") int memberId) {
              return this.baseMemberDeviceService.queryByMemberId(memberId);
       }
       /**
        * 根据设备参数查询设备信息
