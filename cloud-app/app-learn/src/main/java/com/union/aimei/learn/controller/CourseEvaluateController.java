...
public class CourseEvaluateController {
    ...
    public PageInfo<CourseEvaluateResultVo> findByPageForFrontV110(@ApiParam(value = "分页索引", defaultValue = "0") @RequestParam(defaultValue = "0")
    ...
    public ResponseMessage<CourseBeauticianRefVo> checkEvaluateByAnswerV110(@ApiParam(value = "提交数据") @RequestBody CourseEvaluateVo courseEvaluateVo) {
        return this.courseEvaluateService.checkEvaluateByAnswerV110(courseEvaluateVo);
    }
