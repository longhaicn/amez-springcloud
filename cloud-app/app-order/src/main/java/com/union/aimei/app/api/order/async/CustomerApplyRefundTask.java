...
*/
@Component
public class CustomerApplyRefundTask {
    ...
    public void sendMsg(String beauticianPhone,String storePhone,String orderNo,int orderType,Integer productType){
        ...
        beauVo.setSmsCode(SmsConstant.REFUND_NOTIFY_BEAUTICIAN.getSmsCode());
        ...
        if(isStoreSeller){
            ...
            storeVo.setSmsCode(SmsConstant.REFUND_NOTIFY_STORE_FOR_STORE_SELL.getSmsCode());
    ...
    public void pushMsg(OrderSendAppVo vo){
        ...
        beauticianVo.setTemplateCode(ServicePushCodeEnum.USER_REFUND_TO_BEAUTICIAN.getValue());
        ...
        if(vo.getProductType()==0){
            ...
            storeVo.setTemplateCode(ServicePushCodeEnum.USER_REFUND_TO_STORE.getValue());
