...
public class OrderGoodsInfoController {
	 ...
	 Integer pageSize, @ApiParam(value="查询条件") @RequestBody OrderGoodsInfo orderGoodsInfo) {
       ...
       public ResponseMessage<List<OrderGoodsInfo>> queryByOrderId(@PathVariable(value = "orderId") Integer orderId){
              return orderGoodsInfoService.queryByOrderId(orderId);
       }
}