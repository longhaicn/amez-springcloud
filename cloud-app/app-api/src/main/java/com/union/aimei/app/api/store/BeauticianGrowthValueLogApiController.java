...
public class BeauticianGrowthValueLogApiController {
    @Resource
    private BeauticianGrowthValueLogFeign beauticianGrowthValueLogFeign;
    ...
    public ResponseMessage<BeauticianGrowthValueLog> saveV111(@RequestBody BeauticianGrowthValueLog beauticianGrowthValueLog) {
        return this.beauticianGrowthValueLogFeign.saveV111(beauticianGrowthValueLog);
    }
    ...
    public ResponseMessage<PageInfo<BeauticianGrowthValueLog>> listByBeauticianIdV111(@RequestParam(value = "pageNo", defaultValue = "0") Integer pageNo,
        ...
        return this.beauticianGrowthValueLogFeign.listByBeauticianIdV111(pageNo, pageSize, beauticianId);
    }
