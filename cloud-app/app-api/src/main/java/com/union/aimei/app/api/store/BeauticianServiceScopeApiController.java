...
public class BeauticianServiceScopeApiController {
    @Resource
    private BeauticianServiceScopeFeign beauticianServiceScopeFeign;

    /**
     * 新增美容师服务范围（美容师-我的-服务设置-服务范围）
     *
     * @param beauticianServiceScope 美容师服务范围
     * @return
     */
    @ApiOperation(httpMethod = "POST", value = "新增美容师服务范围（美容师-我的-服务设置-服务范围）")
    ...
    public ResponseMessage addV111(@ApiParam(value = "美容师服务范围") @RequestBody BeauticianServiceScope beauticianServiceScope) {
        return this.beauticianServiceScopeFeign.addV111(beauticianServiceScope);
    }

    /**
     * 根据美容师ID查询美容师服务范围（美容师-我的-服务设置-服务范围）
     *
     * @param beauticianId 美容师ID
     * @return
     */
    @ApiOperation(httpMethod = "GET", value = "根据美容师ID查询美容师服务范围（美容师-我的-服务设置-服务范围）")
    ...
    public ResponseMessage<List<BeauticianServiceScope>> findListByBeauticianIdV111(@ApiParam(value = "美容师ID") @PathVariable(value = "beauticianId") int beauticianId) {
        return this.beauticianServiceScopeFeign.findListByBeauticianIdV111(beauticianId);
    }
    ...
    public ResponseMessage selectV111(@ApiParam(value = "条件") @PathVariable(value = "id") int id) {
        return this.beauticianServiceScopeFeign.selectV111(id);
    }
    ...
    public ResponseMessage deleteV111(@ApiParam(value = "ID") @PathVariable(value = "id") int id) {
        return this.beauticianServiceScopeFeign.deleteV111(id);
    }

    /**
     * 修改美容师服务范围（美容师-我的-服务设置-服务范围）
     *
     * @param beauticianServiceScope 美容师服务范围
     * @return
     */
    @ApiOperation(httpMethod = "PUT", value = "修改美容师服务范围（美容师-我的-服务设置-服务范围）")
    ...
    public ResponseMessage<List<BeauticianServiceScope>> modifyV111(@ApiParam(value = "美容师服务范围") @RequestBody BeauticianServiceScope beauticianServiceScope) {
        return this.beauticianServiceScopeFeign.modifyV111(beauticianServiceScope);
    }

    /**
     * 根据ID查询美容师服务范围（美容师-我的-服务设置-服务范围）
     *
     * @param id ID
     * @return
     */
    @ApiOperation(httpMethod = "GET", value = "根据ID查询美容师服务范围（美容师-我的-服务设置-服务范围）")
    ...
    public ResponseMessage<BeauticianServiceScope> findByIdV111(@ApiParam(value = "ID") @PathVariable(value = "id") int id) {
        return this.beauticianServiceScopeFeign.findByIdV111(id);
    }
