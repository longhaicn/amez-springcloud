...
public class BaseDicGroupItemController {
    ...
    public ResponseMessage<List<BaseDicGroupItem>> findListByCode(@PathVariable("bandCode") String bandCode) {
        return new ResponseMessage<>(baseDicGroupItemFeign.findListByCode(bandCode));
    }
}