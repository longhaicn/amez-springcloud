...
import com.union.aimei.common.feign.app.learn.CourseProductRefFeign;
...
public class CourseProductRefApiController {
    ...
    public ResponseMessage<CourseProductRef> findByPageForFront(@ApiParam(value = "分页索引", defaultValue = "0") @RequestParam(value = "pageNo", defaultValue = "0")
        ...
        PageInfo<CourseProductRef> page = courseProductRefFeign.findByPageForFront(pageNo, pageSize, courseProductRef);
        if (page != null) {
            result.setData(page);
        } else {
